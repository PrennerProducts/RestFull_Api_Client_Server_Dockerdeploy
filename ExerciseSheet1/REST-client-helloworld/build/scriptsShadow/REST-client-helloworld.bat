...
set CLASSPATH=%APP_HOME%\lib\REST-client-helloworld-1.0-SNAPSHOT-all.jar

@rem Execute REST-client-helloworld
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %REST_CLIENT_HELLOWORLD_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
